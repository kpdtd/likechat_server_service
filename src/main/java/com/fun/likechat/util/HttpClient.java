...
public class HttpClient {
	...
	public static String postRequestReturnCode(String url, String requestData) throws IOException {
		return Integer.toString(postRequestReturnCode(url, requestData.getBytes(CHARACTER_ENCODING), null));
	}
	...
	public static int postRequestReturnCode(String url, byte[] requestData, Properties requestProperties) throws IOException {
		HttpURLConnection httpConn = null;
		StringBuffer sBuffer = new StringBuffer("");
		int code = 9999;
		try {
	...
	public static String postRequestGBK(String url, byte[] requestData, Properties requestProperties) throws IOException {
		HttpURLConnection httpConn = null;
		StringBuffer sBuffer = new StringBuffer("");
		try {
			httpConn = (HttpURLConnection) new URL(url).openConnection();
	...
	public static String httpsPostRequest(String url, byte[] requestData, Properties requestProperties) throws Exception {
	 ...
	 * @throws IOException
	 */
	public static String postRequest4MakeCode(String url, byte[] requestData, Properties requestProperties) throws IOException {
		HttpURLConnection httpConn = null;
		StringBuffer sBuffer = new StringBuffer("");
		try {
			httpConn = (HttpURLConnection) new URL(url).openConnection();
			...
			httpConn.setRequestMethod("POST");
			httpConn.setRequestProperty("Content-type", "application/x-www-form-urlencoded;text/xml;charset=UTF-8");
