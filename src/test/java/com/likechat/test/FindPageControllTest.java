...
public class FindPageControllTest extends BaseTest {
	...
	public void testFindPage() {
		...
		data.put("stamp", "0");
		try {
			String result=HttpClient.postRequest("http://127.0.0.1:8081/likechat_server_service/find/getFindList", JsonHelper.toJson(data));
